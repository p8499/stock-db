...
if totasset == 0:
    ...
    return cachew(None)
# 负债
totalnoncliab = (rows[0]['totalnoncliab'] + rows[1]['totalnoncliab']) / 2
# 计算
return cachew(totalnoncliab / totasset)
$$
LANGUAGE plpython3u;